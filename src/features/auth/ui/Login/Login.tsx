...
export const Login = () => {
  ...
  const { data: captcha } = useGetCaptchaUrlQuery(undefined, { skip: !captchaRequired })
  ...
  const onSubmit: SubmitHandler<LoginInputs> = async (data) => {
    try {
      ...
      if (res.resultCode === ResultCode.Success) {
        ...
        alert(res.messages[0] || "Login error")
      }
    } catch (err: any) {
      console.error(err)
    }
        ...
        <FormControl>
          ...
          <FormGroup>
            ...
            {captchaRequired && captcha?.url && (
              <>
                <img src={captcha.url} alt="captcha" style={{ margin: "10px 0" }} />
